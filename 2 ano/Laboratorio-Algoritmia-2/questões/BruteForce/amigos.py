...
def amigos(conhecidos):
    # take all the names available and put them in a set
    ...
    # create a dictionary with the names as keys and the values as sets
    for x in amigos:
        adj[x] = set()
...
input = {('pedro','pedro'),('pedro','jose'),('pedro','manuel'),('maria','jose'),('maria','francisca'),('jose','francisca'),('francisca','manuel')}
amigos(input)